...
<body<?php print phptemplate_body_class($sidebar_left, $sidebar_right); ?>>
  ...
  <div id="footer-wrapper" class="clear-block">
    <div class="footer-wrapper-top"><div class="footer-wrapper-top-left"></div></div>
    <div class="footer-wrapper-content">
    
    <div class="f1"><ul>
    	<li><span class="ftitle">Enciclopedii</span></li>
		<li><a href="http://www.bridgeguys.com/" target="_new">Bridgeguys</a></li>
		<li><a href="http://www.bridgehands.com/" target="_new">Bridgehands</a></li>
		<li><a href="http://www.pattayabridge.com/" target="_new">PattayaBridge</a></li>
		<li><a href="http://chrisryall.net/bridge/index.htm" target="_new">Chris Ryall</a></li>
		<li><a href="http://www.duralbridge.com/home.htm" target="_new">DuralBridge</a></li>
	  </ul></div>
	  
      <div class="f2"><ul>
      <li><span class="ftitle">Reviste on-line</span></li>
		<li><a href="http://www.australianbridge.com/" target="_new">A. Bridge</a></li>
		<li><a href="http://www.bridgeworld.com/" target="_new"">Bridgeworld</a></li>
		<li><a href="http://www.mrbridge.co.uk/"target="_new">MrBridge</a></li>
		<li><a href="http://www.bridgevaria.com/" target="_new">Bridgevaria</a></li>
	  </ul></div>
      
	  <div class="f3"><ul>
      <li><span class="ftitle">Bridge Romania</span></li>
		<li><a href="http://bboromania.com/" target="_new">BBO Romania</a></li>
		<li><a href="http://www.bridge-club.ro/b/" target="_new">Bridge-Club</a></li>
		<li><a href="http://bvg22.wordpress.com/" target="_new">Blogul lu' Balita</a></li>
        </ul>
	  </div>
    ...
    <div class="footer-wrapper-bottom"> 
     <div class="footer-wrapper-bottom-left"><div ><a href="http://www.bboromania.com/" target="_new"><img id="bboro" src="/sites/default/files/logo-footer1.png" /></a>
     										<a href="http://www.bridgebase.com/" target="_new"><img id="bboin" src="/sites/default/files/bbo_logo_bw.gif" /></a></div> </div>
