$Id: README.txt,v 1.1.2.10.2.3 2010/06/08 16:13:45 michellec Exp $
...
visibility option. Exclusion of the /edit page happens automatically. You can choose an 
imagecache preset to use for the user picture. You can also use the "caller" field to 
give this instance a unique ID that can be accessed from the preprocess functions and 
the template file.
